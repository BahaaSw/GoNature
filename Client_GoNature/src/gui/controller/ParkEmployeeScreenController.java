...
public class ParkEmployeeScreenController implements Initializable,IScreenController {
	...
	public ParkEmployeeScreenController(User user) {
		this.user=user;
	}
	...
	public void onDashboardClicked() {
		AnchorPane dashboard = GuiHelper.loadRightScreenToBorderPaneWithController("/gui/view/ParkEmployeeDashboard.fxml",ControllerType.Park_Employee_Dashboard_Controller,user);
